...
namespace Christoc.Modules.InnovActionAdvanceSQL.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.InnovActionAdvanceSQL.Data.SqlDataprovider,InnovActionAdvanceSQL";
